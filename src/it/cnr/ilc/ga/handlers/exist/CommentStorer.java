...
public class CommentStorer {
	...
	public boolean store(Comment comment, PericopeComments pc) throws XMLDBException{

		boolean connectionStatus = connect();
		logger.info("connessione comment store was " + (connectionStatus?"ok":"ko!"));
		try {
			...
			logger.fine("docID: " + document.getDocumentId());
			...
			logger.fine("storing document " + document.getId() + "...");
			logger.fine(document.getContent().toString());
			root.storeResource(document);
			logger.fine("Commento salvato con successo");
		} catch (Exception e) {
	...
	public boolean remove(Comment comment){
		...
		if (connectionStatus) {
			...
			try {
				...
				logger.fine("remove() docID: " + document.getDocumentId());
